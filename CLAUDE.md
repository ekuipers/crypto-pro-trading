...
*(none — a 2026-07-08 rescan of the v2026-07-08.1 Autopilot changes found and fixed two defects (trailing stop un-arming on pullback; stale-entry sweep cancelling non-Autopilot orders), shipped as v2026-07-08.2; see `memory/memory.md`.)*
