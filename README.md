...
- **🤖 Autopilot controls always in sight** *(roadmap 2026-07-10 item 11, v2026-07-10.2)* — the Autopilot panel (toggle, interval selector, ⛔ kill switch, activity log) moved directly under the Command-tab KPI tiles, **above** the 🚦 Trading Permission Rules / 📌 Hard Rules grid.
